...
if __name__ == '__main__':
    ...
    figs.append(plot_topncurve(topn, nb_classes))
    figs.append(plot_confusion_matrix(cnf_matrix, classes))
    figs.append(plot_confusion_matrix(cnf_matrix, classes, normalize=True))
    figs += plot_learning_curves(history)

    data = dict()
    data['top1'] = topn[1]*100
    data['top5'] = topn[5]*100
    data['mAP'] = mAP
    data['title'] = title
